...
\begin{itemize}
	\item Developed a deep learning-based software that predicts the operating hours of commercial facilities from time-series data of electric power consumption. Handled noisy data with inaccurate or missing labels. Used the Oracle Database to run machine learning on it.
