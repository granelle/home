...
\textbf{KAIST COVID-19 Task Force}
\hfill \textit{Mar. 2020 - Current}\\
\textit{Supporter: KAIST}
\begin{itemize}
	\item (i) Developed methods to infer daily infected cases from daily confirmed cases. (ii) Developed new epidemic models to understand the spread of the virus. Currently, I am studying ways to combine (i) and (ii) in order to improve prediction accuracy.
\end{itemize}	
